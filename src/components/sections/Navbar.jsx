                 ...
                 >
                   ...
                   {isActive && (
                     <motion.div
                       ...
                       className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3 h-0.5 bg-accent rounded-full"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="absolute top-20 left-3 right-3 p-6 bg-surface/95 backdrop-blur-2xl border border-white/10 rounded-3xl lg:hidden z-100 shadow-2xl"
          >
