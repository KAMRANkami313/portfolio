...
const GithubStats = () => {
  ...
  useEffect(() => {
    fetch('https://api.github.com/users/KAMRANkami313')
      ...
      .then(data => {
        ...
        // Calculate contribution level based on repos
  ...
  return (
    <motion.div 
      ...
      className="p-6 bg-surface/40 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl transition-colors group"
    >
      ...
      <div>
        ...
        <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
          <motion.div 
            ...
            className="h-full bg-linear-to-r from-accent/40 to-accent rounded-full"
          />
        </div>
      </div>

      {/* Mini heatmap */}
      <div ref={gridRef} className="grid grid-cols-8 gap-1 mt-4">
